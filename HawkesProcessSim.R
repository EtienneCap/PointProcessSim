...
plot(t, lambda_t, type = 'l', col = 'red', ylim = c(0, max(lambda_t)), main = "Realisation of a 1D Hawkes point process", xlab = "t", ylab = "Intensity function")
